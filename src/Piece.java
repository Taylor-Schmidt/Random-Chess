...
public abstract class Piece {
     ...
     */
    abstract void move(Space a[][], int currentRow, int currentCol, int newRow, int newCol);
    ...
    boolean legalMove(Space[][] a, int newRow, int newCol) {
     ...
     boolean isASpace(Space[][] a, int row, int col){
        return a[row][col] != null;
    }

    boolean hasAPiece(Space[][] a, int row, int col){
